...
export default {
  ...
  desensitization_list: 'Desensitization List',
  ...
  label_examine: 'Label Examine',
  examine_list: 'Examine List',
  my_examine: 'My Examine',
  already_examine: 'Already Examine',
  my_approval: 'My Examine',
  approve_set: 'Approve Set',

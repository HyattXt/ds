...
<template>
  <NForm :disabled="props.disabled" size="small" label-placement="left" require-mark-placement="left" label-align="right" label-width="120" :rules="rules" :model="resourcesModel" ref="formRef">
  <NGrid x-gap="10">
    <NFormItemGi

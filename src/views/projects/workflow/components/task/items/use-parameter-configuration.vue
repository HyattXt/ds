...
<template>
  <NForm :disabled="props.disabled" size="small" label-placement="left" require-mark-placement="left" label-align="right" label-width="120" :rules="rules" :model="paramModel" ref="formRef">
  <NGrid x-gap="10">
    <NFormItemGi

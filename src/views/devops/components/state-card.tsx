              ...
              <Card title={'任务状态统计'}>
                <div style="display: flex;padding: 10px; height: 90px">
                  ...
                  <span role="img" class="anticon" style="font-size: 16px; padding-right: 8px">
                    <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="23341" width="25" height="25"><path d="M67.1 310.4c-6.7 3.7-6.7 14.1 0 17.7l423.3 239.2c12.2 6.7 27.5 6.7 39.8 0l423.3-239.2c6.7-3.7 6.7-14.1 0-17.7L519.2 65.1c-5.5-3.1-12.2-3.1-17.7 0L67.1 310.4z" fill="#0099CB" p-id="23342"></path><path d="M954.1 503.1l-89.3-50.8L563.2 623c-15.9 9.2-34.3 13.5-52 13.5-17.7 0-36.1-4.3-52-13.5L156.5 452.3l-89.3 50.8c-6.7 3.7-6.7 14.1 0 17.7L490.4 760c12.2 6.7 27.5 6.7 39.8 0l423.3-239.2c7.3-4.2 7.3-14 0.6-17.7z" fill="#0099CB" p-id="23343"></path><path d="M954.1 697.6L863 646.2 562.6 815.7c-15.9 9.2-34.3 13.5-52 13.5s-36.1-4.3-52-13.5L158.3 646.2l-91.1 51.4c-6.7 3.7-6.7 14.1 0 17.7l423.3 239.2c12.2 6.7 27.5 6.7 39.8 0l423.3-239.2c7.2-4.2 7.2-14 0.5-17.7z" fill="#0099CB" p-id="23344"></path></svg>
                  </span>
                    实例总数
                  ...
                  <div style="flex: 1;background-color: #f4f6f9;margin: 0 24px 0 0;padding-top: 16px;padding-left: 16px;padding-bottom: 8px;border-radius: 2px;">
                  <span role="img" class="anticon" style="font-size: 16px; padding-right: 8px">
                    <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8295" width="25" height="25"><path d="M512 41.472c-129.901714 0-247.661714 52.662857-332.8 137.801143A469.211429 469.211429 0 0 0 41.545143 512c0 129.901714 52.662857 247.661714 137.801143 332.726857A469.211429 469.211429 0 0 0 512 982.528c129.901714 0 247.661714-52.662857 332.726857-137.801143A469.211429 469.211429 0 0 0 982.528 512c0-129.901714-52.662857-247.661714-137.801143-332.8A469.211429 469.211429 0 0 0 512 41.545143z" fill="#0099CB" p-id="8296" data-spm-anchor-id="a313x.search_index.0.i12.76293a81UD8Rem" class=""></path><path d="M787.382857 384L500.370286 671.012571a43.885714 43.885714 0 0 1-62.098286 0L279.259429 512l62.098285-62.098286 128 128 256-256 62.025143 62.098286z" fill="#ffffff" p-id="8297" data-spm-anchor-id="a313x.search_index.0.i11.76293a81UD8Rem" class="selected"></path></svg>
                  </span>
                    成功
                  ...
                  <div style="flex: 1;background-color: #f4f6f9;margin: 0 24px 0 0;padding-top: 16px;padding-left: 16px;padding-bottom: 8px;border-radius: 2px;">
                  <span role="img" class="anticon" style="font-size: 16px; padding-right: 8px">
                    <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9463" width="25" height="25"><path d="M512 41.472a470.528 470.528 0 1 0 0 941.056A470.528 470.528 0 0 0 512 41.472z" fill="#0099CB" p-id="9464"></path><path d="M574.025143 512l146.285714-146.285714L658.285714 303.616l-146.285714 146.285714-146.285714-146.285714L303.542857 365.714286l146.285714 146.285714-146.285714 146.285714L365.714286 720.384l146.285714-146.285714 146.285714 146.285714L720.310857 658.285714l-146.285714-146.285714z" fill="#ffffff" p-id="9465" data-spm-anchor-id="a313x.search_index.0.i18.76293a81UD8Rem" class="selected"></path></svg>
                  </span>
                    失败
                  ...
                  <div style="flex: 1;background-color: #f4f6f9;margin: 0 24px 0 0;padding-top: 16px;padding-left: 16px;padding-bottom: 8px;border-radius: 2px;">
                  <span role="img" class="anticon" style="font-size: 16px; padding-right: 8px">
                    <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="18711" width="25" height="25"><path d="M501.94 0A502.121 502.121 0 0 0 0 501.94c0 277.083 224.858 502.002 501.94 502.002s502.002-224.919 502.002-502.001S779.023 0 501.94 0zM401.59 677.647V326.295c0-20.6 23.552-32.648 40.116-20.119l234.436 175.706c13.553 10.06 13.553 30.118 0 40.177L441.705 697.705a25.058 25.058 0 0 1-40.116-20.058z" fill="#0099CB" p-id="18712"></path></svg>
                  </span>
                    正在运行
                  ...
                  <div style="flex: 1;background-color: #f4f6f9;margin: 0 24px 0 0;padding-top: 16px;padding-left: 16px;padding-bottom: 8px;border-radius: 2px;">
                  <span role="img" class="anticon" style="font-size: 16px; padding-right: 8px">
                    <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="13804" width="25" height="25"><path d="M874.058005 149.941995a510.06838 510.06838 0 1 0 109.740156 162.738976 511.396369 511.396369 0 0 0-109.740156-162.738976z" fill="#0099CB" p-id="13805" data-spm-anchor-id="a313x.search_index.0.i43.76293a81UD8Rem" class=""></path><path d="M417.954256 281.533601a41.046923 41.046923 0 0 0-41.77128 40.201839v385.116718a41.892007 41.892007 0 0 0 83.663287 0v-385.116718a41.167649 41.167649 0 0 0-41.892007-40.201839zM606.045744 281.533601a41.046923 41.046923 0 0 0-41.77128 40.201839v385.116718a41.892007 41.892007 0 0 0 83.663287 0v-385.116718a41.167649 41.167649 0 0 0-41.892007-40.201839z" fill="#ffffff" p-id="13806" data-spm-anchor-id="a313x.search_index.0.i44.76293a81UD8Rem" class="selected"></path></svg>
                  </span>
                    暂停
                  ...
                  <div style="flex: 1;background-color: #f4f6f9;margin: 0 24px 0 0;padding-top: 16px;padding-left: 16px;padding-bottom: 8px;border-radius: 2px;">
                  <span role="img" class="anticon" style="font-size: 16px; padding-right: 8px">
                    <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="21344" width="25" height="25"><path d="M510.9 60.7c-245.6 0-446.7 199.8-446.7 446.7C64.2 753 263.9 954 510.8 954s446.6-199.7 446.6-446.6c0.1-245.6-199.6-446.7-446.5-446.7z m139.8 574c0 8.8-7.2 16-16 16H389.3c-8.8 0-16-7.2-16-16V389.3c0-8.8 7.2-16 16-16h245.5c8.8 0 16 7.2 16 16v245.4z" p-id="21345" fill="#0099CB"></path></svg>
                  </span>
                    停止

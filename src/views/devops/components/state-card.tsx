...
const StateCard = defineComponent({
  ...
  setup(props, ctx) {
    ...
    return { onUpdateDatePickerValue, onUpdateProjPickerValue }
  },
  render() {
    const {
      title,
